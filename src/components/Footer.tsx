...
export default function Footer() {
  const menuItems = [
    { to: "/", text: "کافه" },
    { to: "/blog", text: "روزنامه" },
    { to: "/contact", text: "ارتباط با ما" },
  ...
  return (
    <>
          ...
          <div className="md:flex md:items-center md:space-x-12 lg:space-x-24">
            <div className="grid grid-cols-1 gap-y-3 sm:grid-cols-2 gap-x-12 xl:gap-x-24">
              ...
              <div>
                <ul className="space-y-3 text-base font-medium text-white">
                  <li className="flex items-center">
                    <a href="tel:09370290168" className="flex flex-wrap">
                      <svg
                        className="w-5 h-5 mr-2"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
      ...
      <footer className="footer bg-base-200 text-base-content p-10" dir="rtl">
        <nav>
          <h6 className="footer-title">خدمات</h6>
          <a className="link link-hover" href="tel:09370290168">
            طراحی سایت
          </a>
          <a className="link link-hover" href="tel:09370290168">
            مدیریت سئو
        ...
        <nav>
          ...
          {menuItems.map((item, index) => (
            <Link key={index} className="justify-end" to={item.to}>
              {item.text}
            </Link>
          ))}
        </nav>
        <nav>
          <h6 className="footer-title">شرکت ها</h6>
          <a
