        ...
        <div className="w-full max-w-4xl bg-slate-200 rounded-2xl shadow-lg flex flex-col md:flex-row overflow-hidden">
          <div className="w-full md:w-1/2 p-8">
            ...
            <p className="text-gray-600 mb-6 text-right">
              به ما بپیوندید و از مزایای انحصاری بهره مند شوید. به راحتی با حساب
              های اجتماعی ثبت نام کنید یا فرم زیر را پر کنید.
            </p>

            <div className="text-center font-medium text-gray-500 mb-4">
              ثبت نام با شبکه های اجتماعی یا
            </div>
            ...
            <button className="w-full btn btn-success  py-3 rounded-xl transition duration-200 font-medium">
              ایجاد حساب
            </button>
          </div>
          ...
          <div className="hidden md:flex md:w-1/2 bg-blue-50 justify-center items-center">
            <img src="/img/login.jpg" alt="login" className="w-full h-auto" />
          </div>
        </div>
      </div>
    </>
